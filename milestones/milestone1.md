...
This document should be completed and submitted during **Unit 5** of this
...
- [x] Read and understand all required features
  - [x] Understand you **must** implement **all** baseline features and **two**
        custom features
...
- [x] In `readme.md`: list a name and description for all features (minimum 6
      ...
      the features)
- [x] In `planning/user_stories.md`: add all user stories (minimum 10 for full
      points)
